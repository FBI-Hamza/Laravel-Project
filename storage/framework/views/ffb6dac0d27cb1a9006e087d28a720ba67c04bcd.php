    ...
    <section class="scrollable padder">
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo Form::open(array('route'=>'order.store')); ?>

                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Name</label>
                            <?php echo Form::text('name', '', ['placeholder'=>'Enter full name', 'class'=>'form-control input-lg','required']); ?>

                        </div>
                        <div class="form-group">
                            <label>Phone</label>
                            <?php echo Form::text('phone', '', ['placeholder'=>'Enter phone number', 'class'=>'form-control input-lg','required']); ?>

                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <?php echo Form::textarea('address', '', ['placeholder'=>'Enter full address', 'class'=>'form-control input-lg','rows'=>'3','required']); ?>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::date('delivery_date', '', [ 'class'=>'form-control input-lg','required']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::number('quantity', '1', ['placeholder'=>'Enter quantity', 'class'=>'form-control input-lg', 'required']); ?>
